...
@section('content')
    ...
    if(isset($shop)) {
        $name = "Edit Shop";
        $action = route('shops.update', [$shop->id]);
    }
    ?>
                ...
                <div class="card mt-5 p-5">
                    ...
                    <form method="post" action="{{ $action }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" value="{{ @$shop->name }}" class="form-control" required aria-describedby="emailHelp">
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input name="owner" value="{{ @$shop->owner }}" type="text" class="form-control" required>
                            @error('owner')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
